...
const PROGRAM_SCHEDULE = [
    {
        ...
        day1: <>Registration</>,
        day2: <> <strong>Keynote-3:</strong> 6G and Beyond: Enabling Ultra-Connected Societies through Intelligent Networks </>,
        day3: <> <strong>Keynote-6:</strong> The Future of Next-Gen Computing: From Edge–Fog to Quantum and Blockchain Ecosystems </>,
    },
    {
        ...
        day1: (
            <>
                ...
                <br />
                <strong>Keynote:</strong> Technology with Compassion: Lessons from Guru Tegh Bahadur Ji for Ethical Innovation and Sustainable Development <br />
                <em>or</em> <br />
                Guru Teg Bahadur Ji’s universal message of justice with the need for responsible AI and equitable access to emerging technologies.
            </>
        ),
        day2: (
            <>
        ...
        day3: (
            <>
                <strong>Track 6:</strong> Next-Generation Computing & Emerging Trends in Computer Science <br />
                <em>(Venue A, Venue B)</em>
            </>
        ),
    },
    ...
    },
    {
        ...
        day1: (
            <>
                <strong>Keynote-1:</strong> The Future of Intelligent IoT: From Edge Devices to Sustainable Smart Cities <br />
                <br />
                <strong>Track 1:</strong> Smart Embedded Systems & Intelligent IoT <br />
                <em>(Venue A, B)</em>
            </>
        ),
        day2: (
            <>
                <strong>Keynote-4:</strong> Optical and Satellite Networks for a Digitally Inclusive and Climate-Resilient World <br />
                <br />
        ...
        day3: (
            <>
                <strong>Keynote-7:</strong> Responsible AI and Data Science for Global Challenges: From Food Security to Climate Action <br />
                <br />
                <strong>Track 7:</strong> AI, Data Science & Emerging Applications <br />
    ...
    },
    {
        ...
        day1: (
            <>
                <strong>Keynote-2:</strong> Revolutionizing Electronics with 2D Materials and Nano-Devices for a Sustainable Future <br />
                <strong>Track 2:</strong> Advanced Materials for Future Electronics (Venue A, Venue B)
            </>
        ),
        day2: (
            <>
                <strong>Keynote-5:</strong> AI-Driven Electronics: Transforming Communication, Healthcare, and Smart Industries <br />
                <strong>Track 5:</strong> AI-Powered Electronics & Communication Systems (Venue A) + Poster Presentation
            </>
        ),
...
const TRACKS = [
    {
        ...
        topics: [
            "Embedded Hardware & Software Co-Design", "IoT Architectures, Standards & Protocols",
            "Edge/Fog Computing & Cloud Integration", "Cyber-Physical Systems & Digital Twins",
            "IoT for Smart Cities, Healthcare & Agriculture", "Security & Privacy in IoT Devices",
        ],
        plenary: "The Future of Intelligent IoT: From Edge Devices to Sustainable Smart Cities",
    ...
    },
    {
        ...
        topics: [
            "Nanoelectronics & Nanomaterials", "2D Materials (Graphene, MoS₂, etc.)",
            "Semiconductor Devices & Fabrication Technologies", "Flexible, Wearable & Printed Electronics",
            "Energy Storage Materials (Batteries, Supercapacitors)", "Sustainable & Eco-Friendly Electronic Materials",
        ],
        plenary: "Revolutionizing Electronics with 2D Materials and Nano-Devices for a Sustainable Future",
    ...
    },
    {
        ...
        topics: [
            "5G/6G Technologies & Beyond", "Terahertz & mmWave Communications",
            "Massive MIMO, Beamforming & Antenna Design", "Wireless Sensor Networks & Low-Power Communication",
            "Intelligent Networking & Spectrum Management", "Applications: Autonomous Vehicles, Remote Healthcare, Industry 4.0",
        ],
        plenary: "6G and Beyond: Enabling Ultra-Connected Societies through Intelligent Networks",
    ...
    },
    {
        ...
        topics: [
            "Photonics & Optical Signal Processing", "Fiber Optic Communication Systems",
            "Free-Space Optical Communication (FSO)", "Satellite Communication & Deep-Space Networks",
            "Optical Interconnects & Data Centers", "Quantum Communication & Security",
        ],
        plenary: "Optical and Satellite Networks for a Digitally Inclusive and Climate-Resilient World",
    ...
    },
    {
        ...
        topics: [
            "AI for Wireless Communication & Network Optimization", "AI in Signal/Image Processing",
            "Intelligent Circuit & Chip Design", "AI in IoT & Embedded Platforms",
            "Cognitive Radio & Smart Spectrum Allocation", "AI in Robotics, Drones & Autonomous Systems",
        ],
        plenary: "AI-Driven Electronics: Transforming Communication, Healthcare, and Smart Industries",
    ...
    },
    {
        ...
        topics: [
            "Fog & Edge Computing for Low-Latency Applications", "Quantum Computing Algorithms & Architectures",
            "Blockchain for Secure & Transparent Systems", "Federated Learning & Distributed AI Models",
            "High-Performance & Green Computing Architectures", "Emerging Paradigms: Metaverse, Web3 & Digital Twin Ecosystems",
        ],
        plenary: "The Future of Next-Gen Computing: From Edge–Fog to Quantum and Blockchain Ecosystems",
    ...
    },
    {
        ...
        topics: [
            "Machine Learning & Deep Learning Models", "Natural Language Processing & Speech Technologies",
            "Big Data Analytics & Cloud Computing", "AI for Healthcare, Education & Finance",
            "AI for Climate Modeling & Sustainable Development", "Ethical AI, Trustworthy AI & Policy Frameworks",
        ],
        plenary: "Responsible AI and Data Science for Global Challenges: From Food Security to Climate Action",
...
const SPEAKERS = [
    { sr: 1, type: "International", name: "Dr. Elammaran Jayamani", institution: "Swinburne University of Technology Sarawak Campus in Malaysia" },
    { sr: 2, type: "International", name: "Dr. M. Murugappan", institution: "Kuwait College of Science and Technology, Kuwait" },
    { sr: 3, type: "National", name: "Dr. N C Sivaprakash", institution: "Indian Institute of Science · Bangalore" },
    { sr: 4, type: "National", name: "Dr. C. C. Reddy", institution: "IIT Ropar" },
    { sr: 5, type: "National", name: "Dr. Harpreet Singh", institution: "IIT Ropar" },
    { sr: 6, type: "National", name: "Dr. Satwinder Singh", institution: "Central University, Bathinda" },
    { sr: 7, type: "National", name: "Dr. Abir De Sarkar", institution: "IISER-Mohali" },
    { sr: 8, type: "National", name: "Dr. Aditya Trivedi", institution: "BV-IIITM, Gwalior" },
    { sr: 9, type: "National", name: "Dr. Jyothish Malhotra", institution: "National Institute of Technology Delhi" },
    { sr: 10, type: "National", name: "Dr. Sandeep Singh Gill", institution: "NITTTR Chandigarh" },
    { sr: 11, type: "National", name: "Dr. R. N Yadav", institution: "MANIT Bhopal" },
    { sr: 12, type: "National", name: "Dr. Arun Khosla", institution: "NIT Jalandhar" },
    { sr: 13, type: "National", name: "Dr. Habib M Pathan", institution: "Savitribai Phule Pune University, Pune" },
    { sr: 14, type: "National", name: "Dr. Dilbag Singh", institution: "NIT Jalandhar" },
    { sr: 15, type: "National", name: "Dr. Sanjay Marwaha", institution: "SLIET Longowal" },
    { sr: 16, type: "National", name: "Dr. Manoj Saxsena", institution: "Deen Dyal Upadhya University of Delhi" },
    { sr: 17, type: "National", name: "Dr. Sandeep Kumar Arya", institution: "Guru Jambheshwar University of Science and Technology, Hisar" },
    { sr: 18, type: "National", name: "Dr. Sandeep Singh Sandha", institution: "Punjab AI Excellence, Punjab, India" },
];
...
const SDG_ALIGNMENT_TEACHINGS = [
    {
        ...
        details: "Guru Ji gave his life to protect the right of others to practice their faith, echoing values of justice, equality, and institutional trust. Link this to AI ethics, **cybersecurity, and **responsible technology (Tracks 5 & 6).",
        icon: (
    ...
    },
    {
        ...
        details: "Guru Ji emphasized care for all, irrespective of caste, creed, or religion. Connect this to IoT for healthcare, **AI in medical diagnostics, and **global digital inclusion (Tracks 1 & 3).",
        icon: (
    ...
    },
    {
        ...
        details: "Guru Ji taught detachment from materialism and harmony with nature. Relating this to sustainable electronics, **energy-efficient devices, and **climate modeling (Tracks 2, 4 & 6) would strengthen the link.",
        icon: (
    ...
    },
    {
        ...
        details: "Guru Ji embodied selfless service (seva). This aligns with smart cities, **IoT for agriculture/healthcare, and **global collaborations in research (Tracks 1 & 4).",
        icon: (
...
// Component to render individual track details
const TrackDetail = ({ track }:any) => (
    <div className="border border-blue-200 dark:border-blue-700 p-4 rounded-xl bg-blue-50/50 dark:bg-blue-900/40 hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors shadow-sm mb-6">
        <h5 className="text-xl font-bold text-blue-800 dark:text-blue-300 mb-2">{track.title}</h5>
        <p className="font-semibold text-gray-700 dark:text-gray-300 mb-3 text-sm sm:text-base">
            Plenary Talk: <span className="text-blue-600 dark:text-blue-400 italic">{track.plenary}</span>
        </p>
        
        <h6 className="font-semibold text-base mb-1 text-gray-800 dark:text-gray-200">Key Topics:</h6>
        <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-400 ml-4 mb-3 text-sm sm:text-base">
            {/* Responsive grid for topics on larger screens - now simplified */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-1">
                {track.topics.map((topic:any, index:any) => (
                    <li key={index} className="truncate">{topic}</li>
                ))}
            </div>
        </ul>

        <h6 className="font-semibold text-base mb-1 text-gray-800 dark:text-gray-200">SDG Alignment:</h6>
...
// Component to display the alignment of Guru Tegh Bahadur Ji's teachings with SDGs
const AlignmentCard = ({ alignment }:any) => (
    <div className="p-4 sm:p-5 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 transition-shadow duration-300 hover:shadow-xl">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed" 
           dangerouslySetInnerHTML={{ __html: alignment.details.replace(/\\(.?)\\*/g, '<strong>$1</strong>') }}
        />
    </div>
);
        ...
        <div>
          <div className="bg-gray-50 dark:bg-gray-900 min-h-screen p-4 sm:p-8 md:p-10 text-gray-900 dark:text-gray-100 transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 shadow-2xl rounded-3xl p-6 sm:p-8 lg:p-12 border border-blue-100 dark:border-blue-900">
              ...
              <section id="annexure-a" className="mb-12 scroll-mt-24">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {PROGRAM_SCHEDULE.map((session, index) => (
                        ...
                        >
                          ...
                          <td className="p-3 text-gray-700 dark:text-gray-300 align-top">
                            {session.day1}
                          </td>
                          <td className="p-3 text-gray-700 dark:text-gray-300 align-top">
                            {session.day2}
                ...
                <div className="bg-blue-50 dark:bg-gray-700 p-6 rounded-xl border border-blue-200 dark:border-gray-600 shadow-md mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed italic mb-4 border-l-4 border-blue-500 dark:border-blue-400 pl-4 py-1">
                    “This conference is humbly dedicated to the supreme
                    sacrifice of Guru Tegh Bahadur Ji, whose martyrdom stands as
                    an eternal symbol of freedom, justice, and protection of
                    human dignity. As the world advances in electronics,
                    communication, and AI, we draw inspiration from his
                    teachings to ensure that innovation serves humanity,
                    preserves equity, and supports the Sustainable Development
                    Goals (SDGs).”
                  </p>
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed italic border-l-4 border-green-500 dark:border-green-400 pl-4 py-1">
                    ...
                    human dignity, reduces inequalities, and advances the SDGs
                    in the spirit of universal compassion and justice.”
                  </p>
                </div>
              ...
              <section id="conference-tracks" className="mb-12 scroll-mt-24">
                ...
                <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 mb-8">
                  ...
                  addressing key areas of Digital Innovation and directly
                  aligning with specific Sustainable Development Goals (SDGs).
                </p>

                {/* Track Listing - NOW FORCED TO SINGLE COLUMN */}
              ...
              {/* Annexure B: Detailed Speaker List */}
              <section id="annexure-b">
                <h3 className="text-3xl font-bold text-blue-700 dark:text-blue-400 mb-6 border-b-2 pb-2 border-blue-100 dark:border-blue-900">
                  Annexure B: Tentative List of Speakers/Experts
                </h3>
                ...
                <div className="overflow-x-auto shadow-xl rounded-xl border border-gray-200 dark:border-gray-700">
                  <table className="min-w-[800px] w-full text-sm sm:text-base">
                    <thead className="bg-blue-600 dark:bg-blue-700 text-white">
                      <tr>
                        <th className="p-3 w-[5%] rounded-tl-xl">Sr.</th>
                        <th className="p-3 w-[15%] whitespace-nowrap">
                          Status
                        </th>
                        <th className="p-3 w-[30%]">Name of Expert</th>
                        <th className="p-3 w-[50%] rounded-tr-xl">
                          Institution
                        </th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {SPEAKERS.map((speaker) => (
                        ...
                        >
                          ...
                          <td className="p-3 text-center text-blue-700 dark:text-blue-400 font-semibold">
                            {speaker.type}
                          </td>
          ...
          <div className="flex justify-center mt-5">
            <Button variant="outline" className="flex justify-center">
              <a href="/guide-for-author.pdf" className="w-full text-center">
                Download Pdf
              </a>
            </Button>
          </div>
