...
const TRACKS = [
  {
    ...
    topics: [
      ...
      "Edge/Fog Computing & Cloud Integration",
      "Cyber-Physical Systems & Digital Twins",
      "IoT for Smart Cities, Healthcare & Agriculture",
      "Security & Privacy in IoT Devices",
      "IoT in Intelligent Transportation and Traffic Management",
  ...
  },
  {
    ...
    topics: [
      ...
      "Smart Materials and Composites for Mechanical and Civil Engineering Applications",
  ...
  },
  {
    ...
    topics: [
      "5G/6G Technologies & Beyond",
      "Terahertz & mmWave Communications",
      "Massive MIMO, Beamforming & Antenna Design",
      "Wireless Sensor Networks & Low-Power Communication",
      "Intelligent Networking & Spectrum Management",
  ...
  },
  {
    ...
    topics: [
      "Photonics & Optical Signal Processing",
  ...
  },
  {
    ...
    topics: [
      "AI for Wireless Communication & Network Optimization",
      "AI in Signal/Image Processing",
      "Intelligent Circuit & Chip Design",
      "AI in IoT & Embedded Platforms",
      "Cognitive Radio & Smart Spectrum Allocation",
      "AI in Robotics, Drones & Autonomous Systems",
      "AI-Enabled Mechatronic Systems and Intelligent Control",
      "AI for Predictive Maintenance and Fault Diagnosis in Mechanical Systems",
      "Computer Vision and Structural Defect Detection in Civil Infrastructure",
    ],
  ...
  {
    title:
      "Track 6: Next-Generation Computing & Emerging Trends in Computer Science",
    topics: [
      "Fog & Edge Computing for Low-Latency Applications",
      ...
      "High-Performance & Green Computing Architectures",
      "Emerging Paradigms: Metaverse, Web3 & Digital Twin Ecosystems",
  ...
  },
  {
    ...
    topics: [
      ...
      "AI for Healthcare, Education & Finance",
      "AI for Climate Modeling & Sustainable Development",
      "Ethical AI, Trustworthy AI & Policy Frameworks",
      ...
      "Other applications of AI in Mechanical and Civil Engineerin",
    ],
          ...
          <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 shadow-2xl rounded-3xl p-6 sm:p-8 lg:p-12 border border-blue-100 dark:border-blue-900">
            ...
            <section id="annexure-a" className="mb-12 scroll-mt-24">
              ...
              <section
                ...
                className="mb-12 scroll-mt-24 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 p-6 rounded-2xl shadow-lg border border-blue-200 dark:border-gray-700 mb-10"
              >
